                        ...
                        <table class="table table-bordered" id="tblBlasPascal" width="100%" cellspacing="0" style="color: black;">
                            ...
                            while ($row = mysqli_fetch_assoc($queryaulas)) { ?>
                                <tr>
                                    ...
                                    <td>
            <button class="btn btn-danger" onclick="confirmarBorrado(<?php echo $row['idaula']; ?>)">Eliminar</button>
        </td>
                                </tr>
                            <?php } ?>
                            </tbody>
...
function confirmarBorrado(idaula) {
    Swal.fire({
...
function eliminarAula(idaula) {
    ...
    xhr.open('GET', 'deleteAula.php?idaula=' + idaula, true);
