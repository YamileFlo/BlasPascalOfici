...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-09-2024 a las 04:14:59
...
(1, 'Gary Gerardo', 'Aguilar Campos', '73829104', 'M', '2010-03-17', 'Serrán', '$2y$10$JB8XmoHXoAVfVBQrXtfqKebt98oQbXc/AZk6lru7gnbEW9atmhR5e', 1, '', '', '', '', '', '', '', '', '', 'Activo'),
(2, 'Yamile', 'Alegrea Guirre', '13158402', 'F', '2011-11-13', 'San Juan', '$2y$10$Wlio/3WCtQ.OE8A.PKYEVu/BKaufju1DdcVOi/a4q3GdkAoTcW6vm', 1, '', '', '', '', '', '', '', '', '', 'Activo'),
...
(96, 'Jimena Katherine', 'Vinces Quiñones', '83809216', 'F', '2007-06-17', 'San Juan', '', 5, '', '', '', '', '', '', '', '', '', 'Activo'),
...
CREATE TABLE `anuncios` (
  `idanun` int(11) NOT NULL,
  `docente` int(11) NOT NULL,
  `asignaturaaula` int(11) NOT NULL,
  `titulo` varchar(150) NOT NULL,
  `fecpublicacion` varchar(35) NOT NULL,
...
INSERT INTO `anuncios` (`idanun`, `docente`, `asignaturaaula`, `titulo`, `fecpublicacion`, `imagen`, `descripcion`) VALUES
(2, 2, 16, 'Exposición Importante', '2024-07-10T13:06', '', '<p>Buenos d&iacute;as</p>\r\n\r\n<p>No olvidar que ma&ntilde;ana tienen exposici&oacute;n, <strong>traigan sus materiales y lleguen puntuales.</strong></p>\r\n'),
(3, 3, 11, 'IMPORTANTE', '2024-07-18T10:05', '', '<h2 style=\"font-style:italic;\"><strong>Ma&ntilde;ana traer su biblia</strong>, habr&aacute; un trabajo grupal</h2>\r\n');
...
(1, 'Maricielo', 'Muñoz Flores', 72730993, '1990-07-26', 'Sol de Oro 309 - Los Olivos', '902395221', '$2y$10$jh7x9F7aVS41y4e6MkZOLuxyHp1yhvoKJkG529SDUu.oz2JgRLZI.', 'Activo'),
(2, 'Sandra', 'Vásquez', 98765437, '1991-12-07', 'Villa Hermosa', '928503700', '$2y$10$Jg5w3GZlQMTb03XRfan7rOIPq0xKNUqQJUKxv3ttKaQGTH9YsCsc2', 'Activo'),
(3, 'Nila', 'Tomasto', 23394052, '1966-11-04', 'Lima Sur', '923001542', '$2y$10$Hr1At89qsN7dKkLoBXDLs.BrzC1nM5zikr7s7R0gynE91nz7nSQbm', 'Activo'),
...
(6, 'Maura', 'Fernández', 32413327, '1967-12-10', 'Independencia', '921882310', '$2y$10$vDKeCHOba9FiY8OFpdSPZ.99DDNc8Gi/0.b8DaO6RZw16BBnSiIFS', 'Activo'),
(7, 'Yanina', ' Yanina Yanina', 39218821, '1987-07-04', 'Serrán', '932019110', '$2y$10$CoZHjzrGW9HuNjuKNU0K0OKexVYTTBL0FhJZf7jZpt93v9l40w/e.', 'Activo'),
...
ALTER TABLE `anuncios`
  ...
  ADD KEY `asignaturaaula` (`asignaturaaula`);
...
--
ALTER TABLE `anuncios`
  MODIFY `idanun` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `asignar_docente_asignatura`
  MODIFY `idreldoc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
...
--
ALTER TABLE `evaluaciones`
  MODIFY `ideva` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
...
--
ALTER TABLE `anuncios`
  ADD CONSTRAINT `anuncios_ibfk_1` FOREIGN KEY (`asignaturaaula`) REFERENCES `asignar_docente_asignatura` (`idreldoc`) ON DELETE CASCADE ON UPDATE CASCADE;
